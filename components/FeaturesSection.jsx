  ...
  const features = [
    {
      ...
      description: "Get career and educational suggestions tailored specifically to your unique personality and preferences.",
      icon: (
    ...
    },
    {
      ...
      description: "Advanced algorithms map your responses to thousands of educational and career opportunities.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    {
      title: "Save & Compare",
      description: "Save your recommended pathways and easily compare different career options at any time.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    },
    {
      ...
      description: "Engage with a beautifully designed, user-friendly interface that makes exploration enjoyable.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    },
    {
      ...
      description: "Discover educational paths, from trade schools to universities, that align with your career goals.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    },
    {
      ...
      description: "Start, save, and continue your assessment at any time with secure account creation.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
