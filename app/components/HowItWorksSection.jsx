...
export default function HowItWorksSection() {
  ...
  return (
    <section className="py-16 md:py-24 bg-mint-50/50 dark:bg-slate-800/50">
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="hidden md:flex w-2/12 items-center justify-center">
                  <div className={`
                    w-8 h-8 rounded-full border-4 bg-white dark:bg-slate-900 z-10                    ${index % 4 === 0 ? 'border-mint-500' :
