      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-xl font-bold text-blue-600 mb-4">Pathway Infinity</h3>
            <p className="text-gray-600 mb-4">Guiding students to discover their ideal career paths through personalized assessments.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/questionnaire" className="text-gray-600 hover:text-blue-600">Assessment</Link></li>
              <li><Link href="/results" className="text-gray-600 hover:text-blue-600">Results</Link></li>
              <li><Link href="/saved" className="text-gray-600 hover:text-blue-600">Saved Pathways</Link></li>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">© {currentYear} Pathway Infinity. All rights reserved.</p>
          <p className="text-gray-500 text-sm mt-4 md:mt-0">Helping students find their path since 2023</p>
        </div>
      </div>
    </footer>
  );
