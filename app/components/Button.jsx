...
export default function Button({
  ...
  const baseClasses = "group relative inline-flex items-center justify-center px-6 py-3 rounded-full font-medium text-base transition-all duration-300 transform overflow-hidden"; const variantClasses = {
    ...
    outline: "bg-slate-50/80 dark:bg-slate-700/80 backdrop-blur-sm text-sky-600 dark:text-mint-400 border border-sky-200 dark:border-slate-600 hover:border-sky-300 dark:hover:border-mint-500 hover:bg-slate-50 dark:hover:bg-slate-600 hover:-translate-y-0.5 shadow-sm hover:shadow-lg hover:shadow-sky-400/10 dark:hover:shadow-mint-400/10",
    text: "bg-transparent text-sky-600 dark:text-mint-400 hover:text-sky-700 dark:hover:text-mint-300 hover:bg-sky-50 dark:hover:bg-slate-700/50 px-4"
  };
