            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 py-12 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center justify-center">
                        ...
                        <span className="ml-3 text-gray-600 dark:text-gray-300">Loading saved result...</span>
                    </div>
                </div>
            </div>
        );
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 py-8 px-4">
            <div className="max-w-6xl mx-auto">
                ...
                >
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Your Career Match Results</h1>
                    ...
                    {result.results?.analysis && (
                        <section className="mb-12">
                            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Career Path Analysis</h2>
                            <div className="bg-mint-50/30 dark:bg-mint-900/20 rounded-xl p-6 border border-mint-100 dark:border-mint-800">
                                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">{result.results.analysis}</p>
                            </div>
                        </section>
                    )}
                    ...
                    {result.results?.matches && result.results.matches.length > 0 && (
                        <section className="mt-12">
                            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Recommended Trade Schools</h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 justify-items-center">
                                {result.results.matches.map((match, index) => (
                                    <motion.div
                                        ...
                                        className="bg-gradient-to-br from-white via-mint-50 to-blue-50 dark:from-slate-800 dark:via-slate-800 dark:to-slate-700 rounded-2xl shadow-xl overflow-hidden border-2 border-blue-200 dark:border-slate-600 w-full"
                                    >
                                        <div className="p-4">
                                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">{match?.name || 'School Name Not Available'}</h3>
                                            ...
                                            <div className="space-y-6">
                                                {/* Program Details */}
                                                <div>
                                                    <h4 className="text-lg font-semibold text-mint-600 dark:text-mint-400 mb-3 flex items-center">
                                                    ...
                                                    <div className="flex flex-wrap gap-2">
                                                        {match.industries?.map((industry, i) => (
                                                            <span
                                                                key={i}
                                                                className="inline-block bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 rounded-full px-3 py-1 text-sm font-semibold"
                                                            >
                                                                {industry}
                                                            </span>
                                                        )) || (
                                                ...
                                                <div className="w-full border-b-2 border-mint-300/70 dark:border-slate-600 my-6"></div>
                                            ...
                                            <div className="mt-4 grid md:grid-cols-3 gap-4">
                                                {match?.location && (
                                                    <div>
                                                        <h4 className="text-base font-semibold text-mint-600 dark:text-mint-400 mb-1.5 flex items-center">
                                                        ...
                                                        <div className="flex flex-wrap gap-2">
                                                            <span className="inline-block bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 rounded-full px-2.5 py-0.75 text-sm font-semibold">
                                                                {match.location}
                                                            </span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="flex flex-wrap gap-2">
                                                            {match.pathway.map((type, i) => (
                                                                <span
                                                                    key={i}
                                                                    className="inline-block bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 rounded-full px-2.5 py-0.75 text-sm font-semibold -ml-1"
                                                                >
                                                                    {type}
                                                                </span>
                                                            ))}
                    ...
                    <div className="mt-12 flex justify-center space-x-4">
                        ...
                        <Button
                            ...
                            variant="outline"
                            className="text-red-600 dark:text-red-400 border-red-200 dark:border-red-800 hover:bg-red-50 dark:hover:bg-red-900/30 hover:border-red-300 dark:hover:border-red-600"
                        >
                            Delete Result
                        </Button>
                        <Button
